...
/* harmony import */ var just_debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24);
...
/* harmony import */ var morphdom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46);
/* harmony import */ var shopify_asyncview__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(32);
/* harmony import */ var shopify_currency_converter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(26);
...
/* harmony import */ var _shopify_theme_addresses__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(47);
/* harmony import */ var rimg_shopify__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7);
/* harmony import */ var _Forms__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(25);
/* harmony import */ var _components_MessageBanner__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(37);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(StaticCart, [{
    ...
    value: function _bindEvents() {
      ...
      this.$el.on('keyup.cart-page', '[data-cartitem-quantity]', just_debounce__WEBPACK_IMPORTED_MODULE_2___default()(function (event) {
        return _this2._quantityKeyUp(event);
      }, 200));
      /*
    ...
    value: function _editItemQuantity(event) {
      ...
      var quantity = remove ? 0 : cartItemRow.querySelector('.form-field.visible [data-cartitem-quantity]').value;
    ...
    value: function _updateCart(key, quantity) {
      ...
      window.Shopify.changeItem(key, quantity, function (response) {
        _this3._didUpdate(key, quantity, response);
      });
    }
  }, {
    key: "_quantityError",
    ...
    key: "_didUpdate",
    value: function _didUpdate(id, quantity, response) {
      var _this4 = this;
      ...
      shopify_asyncview__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].load('/cart', '_ajax').done(function (_ref) {
        var html = _ref.html;
        ...
        _this4.$el.on('keyup.cart-page', '[data-cartitem-quantity]', just_debounce__WEBPACK_IMPORTED_MODULE_2___default()(function (event) {
          return _this4._quantityKeyUp(event);
        }, 200));
    ...
    value: function _getShippingRates() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax("/cart/shipping_rates.json?".concat(queryString), {
        ...
        if (rates.length > 1) {
          var firstRate = window.Shopify.formatMoney(rates[0].price, _this7.settings.moneyFormat);
        ...
        var ratesList = rates.map(function (rate) {
          var price = window.Shopify.formatMoney(rate.price, _this7.settings.moneyFormat);
...
//# sourceMappingURL=StaticCart.bundle.js.map?1565631014304