...
function () {
  ...
  _createClass(DynamicMenuList, [{
    ...
    value: function _toggleAccordion($block) {
      if (_Layout__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].isBreakpoint('L')) return;
    ...
    value: function onBreakpointChange(event, breakpoints) {
      ...
      } else if (breakpoints.previous === 'L' && !_Layout__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].isBreakpoint('L')) {
...
//# sourceMappingURL=DynamicMenuList.bundle.js.map?1565631014304