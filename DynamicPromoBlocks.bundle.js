...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(23);
...
function () {
  function DynamicPromoBlocks(section) {
    ...
    if (!this.compressBlocks && _Layout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].isBreakpoint('XS')) {
    ...
    if (!this.compressBlocks) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', function () {
        _this.$el.find(_this.content).each(function (index, block) {
          if (_Layout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].isBreakpoint('XS')) {
            adjustHeight(block);
          } else {
            resetHeight(block);
          }
  ...
  _createClass(DynamicPromoBlocks, [{
    ...
    value: function onSectionBlockSelect(block) {
      if (!_Layout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].isBreakpoint('XS')) return;
    ...
    value: function _blockInteraction(event) {
      ...
      if (clicked || !_Layout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].isBreakpoint('XS') || !this.compressBlocks) {
        return;
      }
...
//# sourceMappingURL=DynamicPromoBlocks.bundle.js.map?1565631014304